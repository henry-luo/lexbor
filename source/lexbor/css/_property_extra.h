...
typedef struct {
    lxb_css_value_type_t type;
    // lxb_css_background_position_type_t type;
}
...
typedef struct {
    lxb_css_border_image_source_type_t type;
}
lxb_css_property_border_image_source_t;

typedef struct {
    lxb_css_border_image_slice_type_t type;
}
lxb_css_property_border_image_slice_t;

typedef struct {
    lxb_css_border_image_width_type_t type;
}
lxb_css_property_border_image_width_t;

typedef struct {
    lxb_css_border_image_outset_type_t type;
}
lxb_css_property_border_image_outset_t;

typedef struct {
    lxb_css_border_image_repeat_type_t type;
}
...
typedef struct {
    lxb_css_text_shadow_type_t type;
}
...
typedef struct {
    lxb_css_text_emphasis_style_type_t type;
}
...
typedef struct {
    lxb_css_perspective_type_t type;
}
...
typedef struct {
    lxb_css_transition_property_type_t type;
}
...
typedef struct {
    lxb_css_transition_timing_function_type_t type;
}
...
typedef struct {
    lxb_css_animation_name_type_t type;
}
...
typedef struct {
    lxb_css_animation_timing_function_type_t type;
}
lxb_css_property_animation_timing_function_t;

typedef struct {
    lxb_css_animation_iteration_count_type_t type;
}
...
typedef struct {
    lxb_css_border_collapse_type_t type;
}
lxb_css_property_border_collapse_t;

typedef struct {
    lxb_css_value_type_t horizontal;
    lxb_css_value_type_t vertical;
}
...
typedef struct {
    lxb_css_caret_color_type_t type;
}
...
typedef struct {
    lxb_css_orphans_type_t type;
}
lxb_css_property_orphans_t;

typedef struct {
    lxb_css_widows_type_t type;
}
lxb_css_property_widows_t;

typedef struct {
    lxb_css_value_type_t type;
    // lxb_css_image_orientation_from_type_t type;
}
...
typedef struct {
    lxb_css_quotes_type_t type;
}
lxb_css_property_quotes_t;

typedef struct {
    lxb_css_counter_reset_type_t type;
}
lxb_css_property_counter_reset_t;

typedef struct {
    lxb_css_counter_increment_type_t type;
}
...
typedef struct {
    lxb_css_value_type_t type;
    // lxb_css_overflow_clip_margin_border_type_t type;
}
...
typedef struct {
    lxb_css_value_type_t type;
    // lxb_css_ruby_align_space_type_t type;
}

...
enum {
    ...
    LXB_CSS_PROPERTY_BORDER_RIGHT_STYLE    = 0x0015,
    LXB_CSS_PROPERTY_BORDER_RIGHT_WIDTH    = 0x0016,
    LXB_CSS_PROPERTY_BORDER_STYLE          = 0x0017,
    LXB_CSS_PROPERTY_BORDER_TOP            = 0x0018,
    LXB_CSS_PROPERTY_BORDER_TOP_COLOR      = 0x0019,
    LXB_CSS_PROPERTY_BORDER_TOP_STYLE      = 0x001a,
    LXB_CSS_PROPERTY_BORDER_TOP_WIDTH      = 0x001b,
    LXB_CSS_PROPERTY_BOTTOM                = 0x001c,
    LXB_CSS_PROPERTY_BOX_SIZING            = 0x001d,
    LXB_CSS_PROPERTY_CLEAR                 = 0x001e,
    LXB_CSS_PROPERTY_COLOR                 = 0x001f,
    LXB_CSS_PROPERTY_CURSOR                = 0x0020,
    LXB_CSS_PROPERTY_DIRECTION             = 0x0021,
    LXB_CSS_PROPERTY_DISPLAY               = 0x0022,
    LXB_CSS_PROPERTY_DOMINANT_BASELINE     = 0x0023,
    LXB_CSS_PROPERTY_FLEX                  = 0x0024,
    LXB_CSS_PROPERTY_FLEX_BASIS            = 0x0025,
    LXB_CSS_PROPERTY_FLEX_DIRECTION        = 0x0026,
    LXB_CSS_PROPERTY_FLEX_FLOW             = 0x0027,
    LXB_CSS_PROPERTY_FLEX_GROW             = 0x0028,
    LXB_CSS_PROPERTY_FLEX_SHRINK           = 0x0029,
    LXB_CSS_PROPERTY_FLEX_WRAP             = 0x002a,
    LXB_CSS_PROPERTY_FLOAT                 = 0x002b,
    LXB_CSS_PROPERTY_FLOAT_DEFER           = 0x002c,
    LXB_CSS_PROPERTY_FLOAT_OFFSET          = 0x002d,
    LXB_CSS_PROPERTY_FLOAT_REFERENCE       = 0x002e,
    LXB_CSS_PROPERTY_FONT_FAMILY           = 0x002f,
    LXB_CSS_PROPERTY_FONT_SIZE             = 0x0030,
    LXB_CSS_PROPERTY_FONT_STRETCH          = 0x0031,
    LXB_CSS_PROPERTY_FONT_STYLE            = 0x0032,
    LXB_CSS_PROPERTY_FONT_WEIGHT           = 0x0033,
    LXB_CSS_PROPERTY_HANGING_PUNCTUATION   = 0x0034,
    LXB_CSS_PROPERTY_HEIGHT                = 0x0035,
    LXB_CSS_PROPERTY_HYPHENS               = 0x0036,
    LXB_CSS_PROPERTY_INSET_BLOCK_END       = 0x0037,
    LXB_CSS_PROPERTY_INSET_BLOCK_START     = 0x0038,
    LXB_CSS_PROPERTY_INSET_INLINE_END      = 0x0039,
    LXB_CSS_PROPERTY_INSET_INLINE_START    = 0x003a,
    LXB_CSS_PROPERTY_JUSTIFY_CONTENT       = 0x003b,
    LXB_CSS_PROPERTY_LEFT                  = 0x003c,
    LXB_CSS_PROPERTY_LETTER_SPACING        = 0x003d,
    LXB_CSS_PROPERTY_LINE_BREAK            = 0x003e,
    LXB_CSS_PROPERTY_LINE_HEIGHT           = 0x003f,
    LXB_CSS_PROPERTY_MARGIN                = 0x0040,
    LXB_CSS_PROPERTY_MARGIN_BOTTOM         = 0x0041,
    LXB_CSS_PROPERTY_MARGIN_LEFT           = 0x0042,
    LXB_CSS_PROPERTY_MARGIN_RIGHT          = 0x0043,
    LXB_CSS_PROPERTY_MARGIN_TOP            = 0x0044,
    LXB_CSS_PROPERTY_MAX_HEIGHT            = 0x0045,
    LXB_CSS_PROPERTY_MAX_WIDTH             = 0x0046,
    LXB_CSS_PROPERTY_MIN_HEIGHT            = 0x0047,
    LXB_CSS_PROPERTY_MIN_WIDTH             = 0x0048,
    LXB_CSS_PROPERTY_OPACITY               = 0x0049,
    LXB_CSS_PROPERTY_ORDER                 = 0x004a,
    LXB_CSS_PROPERTY_OVERFLOW_BLOCK        = 0x004b,
    LXB_CSS_PROPERTY_OVERFLOW_INLINE       = 0x004c,
    LXB_CSS_PROPERTY_OVERFLOW_WRAP         = 0x004d,
    LXB_CSS_PROPERTY_OVERFLOW_X            = 0x004e,
    LXB_CSS_PROPERTY_OVERFLOW_Y            = 0x004f,
    LXB_CSS_PROPERTY_PADDING               = 0x0050,
    LXB_CSS_PROPERTY_PADDING_BOTTOM        = 0x0051,
    LXB_CSS_PROPERTY_PADDING_LEFT          = 0x0052,
    LXB_CSS_PROPERTY_PADDING_RIGHT         = 0x0053,
    LXB_CSS_PROPERTY_PADDING_TOP           = 0x0054,
    LXB_CSS_PROPERTY_POSITION              = 0x0055,
    LXB_CSS_PROPERTY_RIGHT                 = 0x0056,

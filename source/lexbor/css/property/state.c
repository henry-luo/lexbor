...
bool lxb_css_property_state_border_top_width(
    lxb_css_parser_t *parser, const lxb_css_syntax_token_t *token, void *ctx) {
    return lxb_css_property_state_mp_top(parser, token, ctx, false);
}
bool lxb_css_property_state_border_right_width(
    lxb_css_parser_t *parser, const lxb_css_syntax_token_t *token, void *ctx) {
    return lxb_css_property_state_mp_top(parser, token, ctx, false);
}
bool lxb_css_property_state_border_bottom_width(
    lxb_css_parser_t *parser, const lxb_css_syntax_token_t *token, void *ctx) {
    return lxb_css_property_state_mp_top(parser, token, ctx, false);
}
bool lxb_css_property_state_border_left_width(
    lxb_css_parser_t *parser, const lxb_css_syntax_token_t *token, void *ctx) {
    return lxb_css_property_state_mp_top(parser, token, ctx, false);
}
...
bool lxb_css_property_state_background(lxb_css_parser_t *parser,
    const lxb_css_syntax_token_t *token, void *ctx) {
    return lxb_css_property_state_color(parser, token, ctx);
}
...
bool lxb_css_property_state_cursor(lxb_css_parser_t *parser,
    const lxb_css_syntax_token_t *token, void *ctx) {
    lxb_css_value_type_t type;
    lxb_css_rule_declaration_t *declar = ctx;
    ...
    switch (type) {
        ...
        /* Local. */
        case LXB_CSS_VALUE_AUTO:
        case LXB_CSS_VALUE_HAND:
        case LXB_CSS_VALUE_POINTER:
        case LXB_CSS_VALUE_MOVE:
        case LXB_CSS_VALUE_GRAB:
        case LXB_CSS_VALUE_GRABBING:
        case LXB_CSS_VALUE_TEXT:
        case LXB_CSS_VALUE_WAIT:
        case LXB_CSS_VALUE_PROGRESS:
            declar->u.cursor->type = type;
            break;
        default:
            return lxb_css_parser_failed(parser);
    }
